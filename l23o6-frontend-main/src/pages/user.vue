  ...
  <el-container>
    ...
    <el-container style="display: flex; align-items: center; height: 85vh">
      ...
      <el-main style="display: flex; justify-content: center; align-items: center">
        <div v-show="index == 1">
          <el-text size="large" type="primary" style="padding-top:110px;display: flex;justify-content: center">
            <h1>个人信息</h1>
          </el-text>
        ...
        <div v-show="index == 2" style="padding-top: 30px; height: 85vh; margin-top: 10vh; width: 65%">
